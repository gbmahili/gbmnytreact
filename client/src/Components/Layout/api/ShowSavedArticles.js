                ...
                <div className="collapsible-body">
                    ...
                    <div className="row">
                        <ul className="collection with-header card">
                            ...
                            {
                                this.props.favoriteSavedArticles.map((article, i) =>
                                    
                                    <li key={article._id} className="collection-item">
                                        <div>
                                            <a href={article.NewsArticleURL} target="_blank">{article.NewsTitle}</a>
                                            <a href="#!" className="secondary-content"><i article_id={article._id} onClick={this.props.deleteArticle} className="material-icons red-text">delete</i></a>
                                        </div>
                                    </li>
                                )
                            }
